...
TestCase** get_all_tests(int* count) {
    ...
    *count = 15;
    ...
    tests[0] = create_test_case("Áàçîâûé: Ñæàòèå 4x4 -> 2x3", test1_input, 4, 4, 2, 3, NULL);
    tests[1] = create_test_case("Áàçîâûé: Ðàñòÿæåíèå 2x2 -> 4x4", test2_input, 2, 2, 4, 4, NULL);
    tests[2] = create_test_case("ÑÐÅÄÍÈÉ: Ñæàòèå 1000x1000 -> 100x100", test3_input, 1000, 1000, 100, 100, NULL);
    tests[3] = create_test_case("ÑÐÅÄÍÈÉ: Ðàñòÿæåíèå 100x100 -> 1000x1000", test4_input, 100, 100, 1000, 1000, NULL);
    tests[4] = create_test_case("ÁÎËÜØÎÉ: Ñæàòèå 2000x2000 -> 200x200", test5_input, 2000, 2000, 200, 200, NULL);
    tests[5] = create_test_case("ÁÎËÜØÎÉ: Ðàñòÿæåíèå 200x200 -> 2000x2000", test6_input, 200, 200, 2000, 2000, NULL);
    tests[6] = create_test_case("Î×ÅÍÜ ÁÎËÜØÎÉ: Ñæàòèå 3000x3000 -> 300x300", test7_input, 3000, 3000, 300, 300, NULL);
    tests[7] = create_test_case("Î×ÅÍÜ ÁÎËÜØÎÉ: Ðàñòÿæåíèå 300x300 -> 3000x3000", test8_input, 300, 300, 3000, 3000, NULL);
    tests[8] = create_test_case("ÝÊÑÒÐÅÌÀËÜÍÛÉ: Ñæàòèå 4000x4000 -> 400x400", test9_input, 4000, 4000, 400, 400, NULL);
    tests[9] = create_test_case("ÝÊÑÒÐÅÌÀËÜÍÛÉ: Ðàñòÿæåíèå 400x400 -> 4000x4000", test10_input, 400, 400, 4000, 4000, NULL);
    tests[10] = create_test_case("ÌÅÃÀ: Ñæàòèå 5000x5000 -> 500x500", test11_input, 5000, 5000, 500, 500, NULL);
    tests[11] = create_test_case("ÌÅÃÀ: Ðàñòÿæåíèå 500x500 -> 5000x5000", test12_input, 500, 500, 5000, 5000, NULL);
    tests[12] = create_test_case("ÃÈÃÀ: Ñæàòèå 6000x6000 -> 600x600", test13_input, 6000, 6000, 600, 600, NULL);
    tests[13] = create_test_case("ÈÍÒÅÍÑÈÂÍÛÉ: Ñèëüíîå ñæàòèå 5000x5000 -> 50x50", test14_input, 5000, 5000, 50, 50, NULL);
    tests[14] = create_test_case("ÈÍÒÅÍÑÈÂÍÛÉ: Ñèëüíîå ðàñòÿæåíèå 50x50 -> 5000x5000", test15_input, 50, 50, 5000, 5000, NULL);
